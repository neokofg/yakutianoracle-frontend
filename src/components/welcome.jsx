        ...
        <div className={"mx-auto px-8"}>
            ...
            <div className={"flex mt-40 gap-8"}>
                <div className={"w-full"}>
                    <div className={"rounded-[24px] bg-white h-[560px]"}>

                    </div>
                    <p className={"mt-5"}>РАЙОНЫ ЯКУТИИ - [22.03.2024]</p>
                </div>
                <div className={"w-full"}>
                    <div className={"rounded-[24px] bg-white h-[463px]"}>

                    </div>
                    <p className={"mt-5"}>ДОСТОПРИМЕЧАТЕЛЬНОСТИ - [22.03.2024]</p>
                </div>
                <div className={"w-full"}>
                    <div className={"rounded-[24px] bg-white h-[626px]"}>
            ...
            <div className={"container mx-auto"}>
                ...
                <div className={"flex justify-between gap-4 mt-40"}>
                    <div className={"bg-white rounded-[32px] w-1/2 px-6 py-6"}>
                        ...
                        <a href="/buy"><button className={"bg-[#008080] w-full rounded-[16px] mt-4 py-3"}>Подключить</button></a>
                    </div>
                    <div className={"bg-white rounded-[32px] w-1/2 px-6 py-6"}>
                        <div className={"flex items-baseline"}>
